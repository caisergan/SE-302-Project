            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden animate-scale-in">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center pt-1">
                                    <input
                                        ...
                                        className="h-4 w-4 text-ieu-500 focus:ring-ieu-500 border-gray-300 rounded cursor-pointer"
                                    />
                ...
                <div className="p-6 border-t border-slate-100 bg-slate-50/50 flex justify-end gap-3">
                    ...
                    <button
                        ...
                        className="bg-ieu-500 text-white hover:bg-ieu-600 px-6 py-2 rounded-lg font-bold shadow-md transition-all transform hover:scale-105 flex items-center gap-2"
                    >
